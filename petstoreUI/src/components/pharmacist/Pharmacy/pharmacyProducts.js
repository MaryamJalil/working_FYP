...
export default class PharmacyProducts extends Component {
    render() {
        return (
          <div>
            <div style={{marginLeft:"65px",marginTop:"30px"}}>
            <Breadcrumb>
  <Breadcrumb.Item href="/pharmacist/pharmacy/addpharmacy">Add Pharmacy</Breadcrumb.Item>
  <Breadcrumb.Item href="/pharmacist/pharmacy/pharmacypicture">
    Pharmacy
  </Breadcrumb.Item>
  <Breadcrumb.Item href="/pharmacist/pharmacy/vaccinepicture">Vaccines</Breadcrumb.Item>
</Breadcrumb>
</div>
