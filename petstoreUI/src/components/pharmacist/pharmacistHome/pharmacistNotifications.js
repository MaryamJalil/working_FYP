...
export default class pharmacistNotifications extends Component {
    render() {
        return (
            <div className="container">
                ...
                <Card style={{ width: '35rem',padding:"20px" ,marginBottom:"30px",backgroundColor:"#f4a261"}}>
                <Card.Title>Feedback</Card.Title>

    
  <Toast style={{backgroundColor:"#f4a261"}}>
    <Toast.Header>
  ...
  </Toast>  <Toast style={{backgroundColor:"#f4a261"}}>
    <Toast.Header>
      <img src="holder.js/20x20?text=%20" className="rounded mr-2" alt="" />
...
>
  ...
  >
    ...
    </Toast> <Toast style={{backgroundColor:"#e76f51"}}>
      <Toast.Header>
        <img src="holder.js/20x20?text=%20" className="rounded mr-2" alt="" />
