...
<Card style={{ width: '18rem' ,  marginLeft:'200px',marginTop:'30px'}}>
...
<Row>
<Card style={{ width: '18rem' ,  marginLeft:'45px',marginTop:'30px'}}>
...
<Card style={{ width: '15rem' ,height:'13rem',  marginLeft:'45px',marginTop:'30px'}}>
