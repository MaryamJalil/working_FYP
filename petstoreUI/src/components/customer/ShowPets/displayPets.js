...
export default class DisplayPets extends Component {
  render() {
    return (
      <div>
        <div className="container">
          <Row>
            <Col>
        <Card body  style={{marginTop:"30px" ,marginLeft:"40px", width: '18rem',backgroundColor:"#ffd6a5"}}>
        ...
        <Button variant="dark">filter</Button>{' '}
          ...
          <Col>
          <Card body  style={{marginTop:"30px" ,marginLeft:"40px", width: '30rem',backgroundColor:"#ffd6a5"}}>
          <Form>
