    ...
    return (
      <div>
        ...
        <div className="container">
          <Row>
            <Col>
        <Card body  style={{marginTop:"30px" ,marginLeft:"40px", width: '18rem',backgroundColor:"#90e0ef"}}>
        ...
        <Button variant="dark">filter</Button>{' '}
          ...
          <Col>
          <Card body  style={{marginTop:"30px" ,marginLeft:"40px", width: '30rem',backgroundColor:"#90e0ef"}}>
          <Form>
  ...
  <ListGroup variant="flush">
      ...
      <ListGroup.Item style={{backgroundColor:"#fdffb6"}}>
        ...
        <Form.Check
          ...
          id="formHorizontalRadios2"
        />
        </ListGroup.Item> <ListGroup.Item style={{backgroundColor:"#fdffb6"}}>
        <Form.Check
          type="radio"
...
<CardDeck style={{ width: '45rem' }}>
  <Card style={{ width: '45rem',backgroundColor:"#caffbf" }}>
