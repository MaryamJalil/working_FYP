...
export default class TakeAppointment extends Component {
    render() {
        return (
...
<Card body border="success" style={{backgroundColor:"#bdb2ff"}}>We're glad you're here. Help us keep pets well, and people safe, by dropping your pet off for their appointment, with phone updates during their visit.
...
<div style={{marginTop:"30px",marginLeft:"30px"}}>
        ...
        <Col>
<Card style={{ width: '18rem' ,backgroundColor:"#fdffb6" }}>
          <Card.Header>PET HEALTH CARE RESOURCES</Card.Header>

  <ListGroup variant="flush">
 
      <ListGroup.Item style={{backgroundColor:"#fdffb6"}}>
...
<Card style={{ width: '40rem', marginTop:"30px",backgroundColor:"#ffc6ff" }}>
  ...
  <Card.Body>
      ...
      <ListGroup style={{backgroundColor:"#ffc6ff"}}>
  <ListGroup.Item style={{backgroundColor:"#ffc6ff"}}>Examine animals to assess their health and diagnose problems</ListGroup.Item>
  <ListGroup.Item style={{backgroundColor:"#ffc6ff"}}>Treat and dress wounds</ListGroup.Item>
  <ListGroup.Item style={{backgroundColor:"#ffc6ff"}}>Perform surgery on animals</ListGroup.Item>
  <ListGroup.Item style={{backgroundColor:"#ffc6ff"}}>Test for and vaccinate against diseases</ListGroup.Item>
  <ListGroup.Item style={{backgroundColor:"#ffc6ff"}}>Operate medical equipment, such as x-ray machines
</ListGroup.Item>
</ListGroup>
