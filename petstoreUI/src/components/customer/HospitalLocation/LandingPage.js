...
Geocode.setApiKey("AIzaSyB2Vw42SYek5N7m0rOxBTfSFht_jL1nkzg");
Geocode.enableDebug();
    ...
    render() {
        ...
        return (
            <div style={{ padding: '1rem', margin: '0 auto', maxWidth: 1000 }}>
                <h1 style={{marginTop:'20px'}}>Hospital Location</h1>
                <br/>
                <Container>
                ...
                <AsyncMap
                    googleMapURL="https://maps.googleapis.com/maps/api/js?key=AIzaSyB2Vw42SYek5N7m0rOxBTfSFht_jL1nkzg&libraries=places"
                    loadingElement={
